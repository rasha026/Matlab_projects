...
this.def["FactorialUsingWhile_DW"] = {file: "FactorialUsingWhile_c.html",line:23,type:"var"};
this.def["FactorialUsingWhile_M_"] = {file: "FactorialUsingWhile_c.html",line:26,type:"var"};
this.def["FactorialUsingWhile_M"] = {file: "FactorialUsingWhile_c.html",line:27,type:"var"};
this.def["FactorialUsingWhile_step"] = {file: "FactorialUsingWhile_c.html",line:31,type:"fcn"};
this.def["FactorialUsingWhile_initialize"] = {file: "FactorialUsingWhile_c.html",line:71,type:"fcn"};
this.def["FactorialUsingWhile_terminate"] = {file: "FactorialUsingWhile_c.html",line:84,type:"fcn"};
this.def["DW_FactorialUsingWhile_T"] = {file: "FactorialUsingWhile_h.html",line:42,type:"type"};
this.def["RT_MODEL_FactorialUsingWhile_T"] = {file: "FactorialUsingWhile_types_h.html",line:23,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["FactorialUsingWhile_c.html"] = "../FactorialUsingWhile.c";
	this.html2Root["FactorialUsingWhile_c.html"] = "FactorialUsingWhile_c.html";
	this.html2SrcPath["FactorialUsingWhile_h.html"] = "../FactorialUsingWhile.h";
	this.html2Root["FactorialUsingWhile_h.html"] = "FactorialUsingWhile_h.html";
	this.html2SrcPath["FactorialUsingWhile_private_h.html"] = "../FactorialUsingWhile_private.h";
	this.html2Root["FactorialUsingWhile_private_h.html"] = "FactorialUsingWhile_private_h.html";
	this.html2SrcPath["FactorialUsingWhile_types_h.html"] = "../FactorialUsingWhile_types.h";
	this.html2Root["FactorialUsingWhile_types_h.html"] = "FactorialUsingWhile_types_h.html";
...
var fileList = [
"ert_main_c.html","FactorialUsingWhile_c.html","FactorialUsingWhile_h.html","FactorialUsingWhile_private_h.html","FactorialUsingWhile_types_h.html","rtwtypes_h.html"];
