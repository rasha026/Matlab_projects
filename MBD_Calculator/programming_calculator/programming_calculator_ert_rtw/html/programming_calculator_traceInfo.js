function RTW_Sid2UrlHash() {
	...
	/* <Root>/In1 */
	this.urlHashMap["programming_calculator:5"] = "programming_calculator.c:37,45,53,61,68&programming_calculator.h:41";
	/* <Root>/In2 */
	this.urlHashMap["programming_calculator:6"] = "programming_calculator.c:38,46,54,62,74&programming_calculator.h:42";
	/* <Root>/Logical
Operator */
...
Operator3 */
	...
	/* <Root>/Logical
Operator4 */
	this.urlHashMap["programming_calculator:22"] = "programming_calculator.c:69";
	/* <Root>/Logical
Operator5 */
	this.urlHashMap["programming_calculator:23"] = "programming_calculator.c:75";
	/* <Root>/Out1 */
	...
	/* <Root>/Out5 */
	this.urlHashMap["programming_calculator:24"] = "programming_calculator.c:67&programming_calculator.h:51";
	/* <Root>/Out6 */
	this.urlHashMap["programming_calculator:25"] = "programming_calculator.c:73&programming_calculator.h:52";
...
function RTW_rtwnameSIDMap() {
	...
	this.rtwnameHashMap["<Root>/Logical Operator4"] = {sid: "programming_calculator:22"};
	this.sidHashMap["programming_calculator:22"] = {rtwname: "<Root>/Logical Operator4"};
	this.rtwnameHashMap["<Root>/Logical Operator5"] = {sid: "programming_calculator:23"};
	this.sidHashMap["programming_calculator:23"] = {rtwname: "<Root>/Logical Operator5"};
	...
	this.rtwnameHashMap["<Root>/Out5"] = {sid: "programming_calculator:24"};
	this.sidHashMap["programming_calculator:24"] = {rtwname: "<Root>/Out5"};
	this.rtwnameHashMap["<Root>/Out6"] = {sid: "programming_calculator:25"};
	this.sidHashMap["programming_calculator:25"] = {rtwname: "<Root>/Out6"};
